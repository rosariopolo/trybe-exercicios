...
const greet = (person, cumprimento = 'Hi') => `${cumprimento} ${person}`;
// Retornos esperados:
...
const [ student11, [ student22, student3 ], [ student4, student5 ] ] = moreStudents;

console.log(student11, student22, student3, student4, student5);